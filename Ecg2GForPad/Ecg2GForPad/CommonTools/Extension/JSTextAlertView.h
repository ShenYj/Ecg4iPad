...
/*** 展示弹框 ***/
- (void)showComposeViewWithCompeletionHandler: (void (^)())compeletionHandler;
/*** 移除弹框 ***/
...
/*** 水平方向两个button ***/
- (void)adjoinWithLeftAction: (JSTextAlertButton *)leftAction
                 rightAction: (JSTextAlertButton *)rightAction;
